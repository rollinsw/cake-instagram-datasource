 ...
 * CommentsTestCase
 */
class CommentsTestCase extends CakeTestCase {
	...
	public function testDelete() {
		$result = \Instagram\Comments::delete(555, 1234);
	...
	public function testGet() {
		$result = \Instagram\Comments::get(555);
		$this->assertIsA($result, 'stdClass', 'Result is not an object');
	...
	public function testPost() {
		$result = \Instagram\Comments::post(555, 'This is a test');
		$this->assertIsA($result, 'stdClass', 'Result is not an object');
		$this->assertTrue(isset($result->meta), 'Result does not contain meta data');
	}
